...
export const myProjects: ProjectModel[] = [
    ...
    },
    {
        ...
        paragraphs: [
            ...
            {
                "subtitle": "Postman",
                "html": "🧑‍💻 Using <a className='bold-text' href='https://www.postman.com/' target='_blank' rel='noreferrer'>Postman</a> significantly helped me develop this project by allowing thorough <span className='bold-text'>testing</span> and <span className='bold-text'>debugging</span> during the development phase. <span className='bold-text'>Postman</span> is an essential tool for building and testing servers, enabling developers to send <span className='bold-text'>HTTP requests</span> and receive responses efficiently. It supports various request methods (<span className='bold-text'>GET</span>, <span className='bold-text'>POST</span>, <span className='bold-text'>PUT</span>, <span className='bold-text'>DELETE</span>) and formats (<a className='bold-text' href='https://www.json.org/' target='_blank' rel='noreferrer'>JSON</a>, <a className='bold-text' href='https://www.w3schools.com/xml/xml_whatis.asp' target='_blank' rel='noreferrer'>XML</a>). <span className='bold-text'>Postman simplifies debugging</span> and ensures <a className='bold-text' href='https://blog.hubspot.com/website/api-endpoint#:~:text=An%20API%20endpoint%20is%20a,a%20resource%20on%20the%20server.' target='_blank' rel='noreferrer'>API endpoints</a> work correctly, <span className='bold-text'>enhancing productivity</span> and <span className='bold-text'>accuracy in server development</span>. Its <span className='bold-text'>intuitive interface</span> and <span className='bold-text'>powerful features</span> make it invaluable for testing and documentation.",
    ...
    },
    {
        ...
        projectRoute: {
            route: "/portfolio/my-portfolio",
            icon: <Apps sx={AppComponentsStyle.headerRouteIcon} />
        },
        isFavorite: true,
        paragraphs: [
            {
    ...
    },
    {
        ...
        projectRoute: {
            route: "/portfolio/online-music-alarm",
            icon: <AccessAlarm sx={AppComponentsStyle.headerRouteIcon} />
        },
        paragraphs: [
            {
    ...
    },
    {
        ...
        projectRoute: {
            route: "/portfolio/todo-board",
            icon: <FormatListBulleted sx={AppComponentsStyle.headerRouteIcon} />
        },
        paragraphs: [
            {
